...
const dokters: Dokter[] = [
  ...
  {
    name: "Dr. Kevin Pratama, Sp.JP(K)",
    specialty: "Kardiologi Intervensi",
    subSpecialty: "Intervensi",
    experience: "20+ tahun",
    education: "Universitas Hasanuddin",
    avatar: "/api/placeholder/150/150?text=KP",
    bio: "Pakar intervensi jantung dengan pengalaman internasional. Pernah bekerja di Mayo Clinic, kini fokus pada pengembangan teknik TAVI di Asia.",
    expertise: [
      "TAVI (Transcatheter Aortic Valve Implantation)",
      "Angioplasti Kompleks",
      "Manajemen Serangan Jantung",
      "Intervensi Non-Koronari",
      "Pelatihan Intervensi Internasional",
    ],
    hospitals: ["RS Jantung Global Makassar", "RS Internasional Nusantara"],
    rating: 4.95,
    reviewsCount: 310,
    schedule: {
      Senin: "09:00 - 13:00",
    ...
    patientReviews: [
      {
        ...
        rating: 5,
        comment:
          "Sangat profesional, prosedur TAVI berjalan lancar tanpa komplikasi.",
        verified: true,
        helpful: 42,
    ...
    achievements: [
      {
        ...
        icon: "🌍",
        description: "Diundang sebagai pembicara utama tentang TAVI di Eropa.",
      },
      {
        title: "Lifetime Achievement Award",
        year: "2024",
        organization: "Indonesian Cardiology Association",
        icon: "🏅",
        description: "Penghargaan atas kontribusi lebih dari 20 tahun.",
      },
    ],
    publications: [
      {
        title: "TAVI Outcomes in Southeast Asia",
        journal: "Journal of Interventional Cardiology",
        year: "2024",
        citations: 75,
        abstract: "Laporan hasil TAVI di 500 pasien Asia Tenggara.",
      },
    ],
    consultationFee: "Rp 700.000",
    responseTime: "< 1 jam",
    availableToday: true,
    onlineConsultation: true,
    emergencyAvailable: true,
    ...
    yearsActive: 20,
    socialMedia: {
      linkedin: "linkedin.com/in/kevinpratama",
      website: "drkevinpratama.com",
    },
    caseStudies: [
      {
        title: "TAVI pada pasien usia 90 tahun",
        description: "Kasus kompleks dengan risiko tinggi.",
        outcome: "Pasien berhasil pulih dengan cepat.",
        year: "2024",
      },
    ],
    ratingDistribution: { 5: 260, 4: 45, 3: 4, 2: 1, 1: 0 },
    monthlyPatients: [
      { month: "Jan", patients: 210 },
      { month: "Feb", patients: 220 },
      { month: "Mar", patients: 200 },
      { month: "Apr", patients: 230 },
      { month: "Mei", patients: 250 },
      { month: "Jun", patients: 260 },
    ],
  },
  {
    name: "Prof. Dr. Muhammad Alvin Faris, Sp.JP(K), PhD, FACC, FHRS, FESC, FAPSIC",
    specialty: "Kardiologi Elektrofisiologi & Inovasi Digital",
    subSpecialty: "Elektrofisiologi",
    experience: "25+ tahun",
    education:
      "Harvard Medical School, Stanford University, Universitas Indonesia",
    avatar: "/api/placeholder/150/150?text=MAF",
    bio: "Profesor elektrofisiologi kelas dunia. Lulusan Harvard & Stanford, pionir dalam pengembangan ablasi berbasis AI, wearable jantung generasi baru, dan terapi gen untuk aritmia kompleks. Menjabat sebagai konsultan global di World Heart Federation dan peneliti utama dalam konsorsium riset internasional di Amerika, Eropa, dan Asia. Dikenal sebagai 'The Future of Cardiac Electrophysiology'.",
    expertise: [
      "Ablasi AI-Driven 4D Mapping",
      "Tele-Elektrofisiologi Global",
      "Wearable Cardiac Device & Bioengineering",
      "Gene Editing (CRISPR) untuk Aritmia",
      "Hybrid EP Surgery + Robotics",
    ],
    hospitals: [
      "National University Hospital Singapore",
      "Mayo Clinic (Collaborative Asia)",
      "RS Jantung Global Indonesia",
    ],
    rating: 5.0,
    reviewsCount: 890,
    schedule: {
    ...
    patientReviews: [
      {
        ...
        rating: 5,
        comment:
          "Dokter legendaris. Rasanya ditangani langsung oleh profesor dunia.",
        verified: true,
        helpful: 120,
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Prosedur robotic-EP sangat aman. Jepang bangga dengan kolaborasi beliau.",
        verified: true,
        helpful: 95,
    ...
    certifications: [
      ...
      "Fellow of the Asia Pacific Society of Interventional Cardiology (FAPSIC)",
      "Harvard Global Health Leadership Program",
      "Stanford Bioengineering Fellowship",
    ],
    achievements: [
      {
        title: "Global Pioneer in AI Electrophysiology",
        year: "2025",
        organization: "World Heart Federation",
        icon: "🌍",
        description:
          "Menciptakan sistem ablasi berbasis kecerdasan buatan pertama di dunia.",
      },
      {
        title: "Nobel Prize Nominee in Medicine",
        year: "2024",
        organization: "Nobel Assembly, Karolinska Institutet",
        icon: "🏅",
        description:
          "Dinominasikan berkat riset terapi gen untuk aritmia fatal.",
      },
      {
        ...
        icon: "👑",
        description:
          "Penghargaan atas dedikasi 25 tahun dalam elektrofisiologi.",
      },
    ],
    publications: [
      {
        title: "Next-Generation AI in Electrophysiology",
        journal: "Nature Medicine",
        year: "2025",
        citations: 320,
        abstract: "Penggunaan AI untuk prediksi outcome ablasi 4D.",
      },
      {
        title: "CRISPR-Based Therapy for Genetic Arrhythmias",
        journal: "The Lancet",
        year: "2024",
        citations: 410,
        abstract:
          "Uji klinis terapi gen berbasis CRISPR untuk pasien Sindrom Brugada.",
      },
      {
        title: "Robotic Hybrid Surgery in Cardiac Electrophysiology",
        journal: "New England Journal of Medicine",
        year: "2023",
        citations: 280,
        abstract: "Pionir operasi hybrid robotik untuk aritmia kompleks.",
      },
      {
        title: "Global Tele-EP Collaboration Model",
        journal: "Circulation",
        year: "2022",
        citations: 220,
        abstract:
          "Implementasi telemedicine dalam elektrofisiologi lintas negara.",
      },
    ],
    consultationFee: "Rp 2.500.000",
    ...
    yearsActive: 25,
    socialMedia: {
      linkedin: "linkedin.com/in/profmuhammadalvinfaris",
      website: "profalvinfaris.com",
      twitter: "twitter.com/profalvinfaris",
    },
    caseStudies: [
      {
        title: "Kasus Ablasi Genetik Multinasional",
        description: "Studi pada 1000 pasien di 5 benua.",
        outcome: "Keberhasilan 98% tanpa komplikasi serius.",
        year: "2024",
      },
      {
        title: "Tele-EP untuk Pasien di Daerah Terpencil",
        description: "Kolaborasi remote dengan perangkat wearable.",
        outcome: "Menurunkan mortalitas 40% di desa terpencil.",
        year: "2023",
      },
    ],
    ratingDistribution: { 5: 860, 4: 25, 3: 5, 2: 0, 1: 0 },
    monthlyPatients: [
      { month: "Jan", patients: 450 },
      { month: "Feb", patients: 470 },
      { month: "Mar", patients: 460 },
      { month: "Apr", patients: 480 },
      { month: "Mei", patients: 490 },
