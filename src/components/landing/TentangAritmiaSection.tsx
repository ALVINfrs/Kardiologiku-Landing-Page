...
const arrhythmiaData: Arrhythmia[] = [
  ...
  },
  {
    ...
    subtitle: "Listrik Tanpa Denyut",
    description:
      "Aktivitas listrik jantung terlihat di EKG tetapi tidak menghasilkan denyut nadi yang efektif.",
    risk: "Sangat Berbahaya",
    icon: ZapOff,
    color: "red",
    longDescription:
      "PEA adalah kondisi darurat di mana monitor EKG menunjukkan aktivitas listrik jantung, tetapi jantung tidak mampu memompa darah secara efektif. Ini sering terjadi sebagai komplikasi dari kondisi yang mengancam nyawa seperti hipovolemia berat, tamponade jantung, atau emboli paru masif.",
    symptomsList: [
    ...
    diagnosis: [
      "Penilaian klinis (tidak ada nadi dengan aktivitas listrik di monitor)",
      "EKG menunjukkan kompleks QRS terorganisir",
      "Point-of-care ultrasound untuk mencari penyebab",
    ],
    treatment: [
      "CPR berkualitas tinggi",
      "Identifikasi dan atasi penyebab (5H5T)",
      "Epinephrine 1mg IV setiap 3-5 menit",
      "Terapi cairan agresif jika hipovolemia",
    ],
    ekgPath:
      "M0 50 l10 0 l5 -10 l5 10 l10 0 l5 -10 l5 10 l10 0 l5 -10 l5 10 l10 0",
    firstAid: [
      "Segera mulai CPR berkualitas tinggi",
      "Aktifkan sistem emergensi (118/112)",
      "Pasang AED dan ikuti instruksi",
      "Fokus pada kompresi dada yang dalam dan cepat",
    ],
    preventionTips: [
      "Kenali dan atasi faktor risiko kardiovaskular",
      "Pemeriksaan kesehatan rutin",
      "Latihan CPR untuk keluarga",
      "Waspadai tanda-tanda awal syok",
    ],
    approximateBPM: 0,
    cprVideoUrl: "https://www.youtube.com/watch?v=mGk0QpyAOlQ",
  },
  {
    category: "Irama Ektopik (Denyut Tambahan)",
    title: "Long QT Syndrome (LQTS)",
    subtitle: "Kelainan Genetik Repolarisasi",
    description:
      "Gangguan kelistrikan jantung yang memperpanjang interval QT, meningkatkan risiko aritmia fatal.",
    risk: "Tinggi",
    icon: Dna,
    color: "indigo",
    longDescription:
      "LQTS adalah kelainan genetik yang mempengaruhi repolarisasi sel jantung, terlihat sebagai pemanjangan interval QT pada EKG. Kondisi ini meningkatkan risiko aritmia ventrikel berbahaya, terutama Torsades de Pointes, yang dapat menyebabkan pingsan atau kematian mendadak.",
    symptomsList: [
      "Pingsan saat aktivitas fisik atau emosi kuat",
      "Kejang",
      "Palpitasi",
      "Kematian jantung mendadak pada usia muda",
      "Riwayat keluarga dengan gejala serupa",
    ],
    riskFactors: [
      "Mutasi genetik",
      "Riwayat keluarga dengan LQTS",
    ...
    diagnosis: [
      ...
      "Holter monitor",
      "Uji latih jantung",
      "Riwayat keluarga detail",
    ],
    treatment: [
      "Beta blocker",
      "Implantable Cardioverter-Defibrillator (ICD)",
      "Modifikasi gaya hidup",
      "Hindari obat yang memperpanjang QT",
      "Terapi genetik (dalam penelitian)",
    ],
    ekgPath: "M0 50 l10 0 l5 -20 l20 40 l5 -30 l10 0",
    firstAid: [
      "Posisikan korban dalam keadaan berbaring",
      "Periksa kesadaran dan napas",
      "Siapkan CPR jika diperlukan",
      "Panggil bantuan medis segera",
    ],
    preventionTips: [
      "Screening genetik untuk keluarga",
      "Hindari obat yang memperpanjang QT",
      "Jaga keseimbangan elektrolit",
      "Konsultasi sebelum mulai olahraga kompetitif",
  ...
  {
    category: "Takikardia (Detak Cepat)",
    title: "Wide Complex Tachycardia (WCT)",
    subtitle: "Takikardia Kompleks Lebar",
    description:
      "Irama cepat dengan QRS lebar yang memerlukan diagnosis dan penanganan cepat untuk membedakan VT dari SVT dengan aberansi.",
    risk: "Berbahaya",
    icon: AlertTriangle,
    color: "orange",
    longDescription:
      "Wide Complex Tachycardia adalah temuan EKG yang menunjukkan irama cepat dengan kompleks QRS melebar (>120ms). Hingga dibuktikan sebaliknya, WCT harus dianggap sebagai Ventricular Tachycardia dan ditangani sesuai protokol VT untuk keamanan pasien.",
    symptomsList: [
      "Palpitasi hebat",
      "Nyeri dada",
      "Sesak napas",
    ...
    diagnosis: [
      ...
      "Algoritma Brugada",
      "Kriteria Wellens",
      "Respon terhadap adenosine",
      "Studi elektrofisiologi",
    ],
    treatment: [
      "Kardioversi tersinkronisasi jika tidak stabil",
      "Amiodarone atau Procainamide IV jika stabil",
      "Koreksi elektrolit",
      "Ablasi kateter untuk kasus berulang",
    ],
    ekgPath: "M0 50 l5 0 l10 -30 l10 30 l10 -30 l10 30 l10 -30 l10 30 l5 0",
    firstAid: [
    ...
    preventionTips: [
      "Kontrol penyakit jantung dasar",
      "Pemeriksaan elektrolit rutin",
      "Hindari pemicu yang diketahui",
      "Follow-up kardiologi teratur",
    ],
    approximateBPM: 150,
    cprVideoUrl: "https://www.youtube.com/watch?v=mGk0QpyAOlQ",
  },
